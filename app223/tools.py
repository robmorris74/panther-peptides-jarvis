...
def tool_specs():
 ...
 {'type':'function','function':{'name':'github_write_file','description':'Write/update an explicitly authorized code/config file in GitHub. Use this when the owner asks Jarvis to change the dashboard, interface, application behavior, or configuration.','parameters':{'type':'object','properties':{'path':{'type':'string'},'content':{'type':'string'},'message':{'type':'string'}},'required':['path','content','message']}}},
 ...
 {'type':'function','function':{'name':'knowledge_search','description':'Search the full persistent Jarvis knowledge library. Use before answering business-specific questions when uploaded material may be relevant.','parameters':{'type':'object','properties':{'query':{'type':'string'}},'required':['query']}}},
