...
from .self_engineering import start_release,read_file as engineering_read,write_file as engineering_write,diff as engineering_diff,run_ci as engineering_run_ci,status as engineering_status,deploy_staging,verify_staging,promote,verify_production,list_releases
...
def tool_specs():
 ...
 {'type':'function','function':{'name':'engineering_start_release','description':'Create an isolated Jarvis self-engineering candidate branch from current production. Use this before any self-code change.','parameters':{'type':'object','properties':{'summary':{'type':'string'}},'required':['summary']}}},
 {'type':'function','function':{'name':'engineering_read_file','description':'Read a source/config file from an isolated engineering release branch.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'},'path':{'type':'string'}},'required':['release_id','path']}}},
 {'type':'function','function':{'name':'engineering_write_file','description':'Write a non-protected file only to an isolated engineering release branch. Never writes directly to production/main.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'},'path':{'type':'string'},'content':{'type':'string'},'message':{'type':'string'}},'required':['release_id','path','content','message']}}},
 {'type':'function','function':{'name':'engineering_diff','description':'Inspect all changes and risk classification for a self-engineering release.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'}},'required':['release_id']}}},
 {'type':'function','function':{'name':'engineering_run_ci','description':'Run the isolated compile/import/test/deployment-contract release gate.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'}},'required':['release_id']}}},
 {'type':'function','function':{'name':'engineering_status','description':'Read release, CI and diff status. Use after every CI dispatch and engineering mutation.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'}},'required':['release_id']}}},
 ...
 {'type':'function','function':{'name':'engineering_promote','description':'Promote a staging-verified release to main and production. This fails closed unless the owner has explicitly approved the release.','parameters':{'type':'object','properties':{'release_id':{'type':'integer'}},'required':['release_id']}}},
 ...
 {'type':'function','function':{'name':'knowledge_search','description':'Search the persistent Panther knowledge library.','parameters':{'type':'object','properties':{'query':{'type':'string'}},'required':['query']}}},
 ...
 {'type':'function','function':{'name':'inventory_list','description':'Read current Panther Peptides inventory.','parameters':{'type':'object','properties':{}}}},
 ...
 {'type':'function','function':{'name':'request_owner_approval','description':'Ask exactly one blocking yes/no question for production promotion, protected engineering changes, external commitment, credential/security change, irreversible action, or spend. Every spend requires approval.','parameters':{'type':'object','properties':{'question':{'type':'string'},'action':{'type':'string'},'rationale':{'type':'string'},'estimated_cost':{'type':'number','maximum':300}},'required':['question','action','rationale']}}},
